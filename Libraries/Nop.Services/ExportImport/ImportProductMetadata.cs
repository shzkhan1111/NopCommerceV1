...
namespace Nop.Services.ExportImport
{
    public class ImportProductMetadata
    {
        ...
        public IList<PropertyByName<Product>> ProductProperties { get; set; }
        public IList<PropertyByName<Product>> ProductAttributes { get; set; }
        public IList<PropertyByName<Product>> SpecificationAttribures { get; set; }
