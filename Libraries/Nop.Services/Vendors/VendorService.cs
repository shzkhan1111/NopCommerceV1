...
namespace Nop.Services.Vendors
{
    ...
    public partial class VendorService : IVendorService
    {
        ...
        /// <summary>
        /// Get vendor  by customer quote Id
        /// </summary>
        /// <param name="customerQuoteId"></param>
        /// <returns></returns>
        public virtual async Task<List<Vendor>> GetVendorByCustomerQuoteIdAsync(int customerQuoteId)
        {
            if (customerQuoteId == 0)
                return null;

            var order = await (from o in _vendorQuoteRepository.Table
                               join v in _vendorRepository.Table on o.VendorId equals v.Id
                               where o.CustomerQuoteId == customerQuoteId
