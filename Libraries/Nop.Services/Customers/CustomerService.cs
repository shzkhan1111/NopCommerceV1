...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        private readonly IRepository<CustomerQuote> _customerQuoteRepository;
        ...
        public CustomerService(CustomerSettings customerSettings,
            ...
            IRepository<CustomerQuote> customerQuoteRepository)
        {
            ...
            _customerQuoteRepository = customerQuoteRepository;
        }
        ...
        /// <summary>
        /// Get customers by customer quoteId
        /// </summary>
        /// <param name="customerQuoteId">The order identifier</param>
        /// <returns>
        /// A task that represents the asynchronous operation
        /// The task result contains the customers
        /// </returns>
        public virtual async Task<List<Customer>> GetCustomerByCustomerQuoteIdAsync(int customerQuoteId)
        {

            var customers = await (from cq in _customerQuoteRepository.Table
                                   join c in _customerRepository.Table on cq.CustomerId equals c.Id
                                   where cq.Id == customerQuoteId
