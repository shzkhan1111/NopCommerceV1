...
namespace Nop.Web.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(IServiceCollection services, ITypeFinder typeFinder, AppSettings appSettings)
        {
            ...
            services.AddScoped<Factories.IQuoteModelFactory, Factories.QuoteModelFactory>();
            ...
            services.AddScoped<Factories.IChatModelFactory, Factories.ChatModelFactory>();
            services.AddScoped<Factories.IFileManager, Factories.FileManager>();
        }
