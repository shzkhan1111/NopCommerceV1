...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : BaseRouteProvider, IRouteProvider
    {
        ...
        public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
        {
            ...
            //Messenger
            //endpointRouteBuilder.MapControllerRoute(name: "Messenger",
            //    pattern: $"{lang}/{{action=Index}}/{{id?}}",
            //    defaults: new { controller = "Messenger", action = "Index" });

            //endpointRouteBuilder.MapControllerRoute(name: "Admin/Messenger/Index",
            //    pattern: $"{lang}/Admin/Msessenger/Index/{{id?}}",
            //    defaults: new { controller = "Messenger", action = "Index" });
            ...
            endpointRouteBuilder.MapControllerRoute(name: "CreateInquiry",
                pattern: $"{lang}/createinquiry",
                defaults: new { controller = "Common", action = "CreateInquiry" });

            endpointRouteBuilder.MapControllerRoute(name: "InquirySuccess",
               pattern: $"{lang}/inquirysuccess",
               defaults: new { controller = "Common", action = "InquirySuccess" });
            ...
            endpointRouteBuilder.MapControllerRoute(name: "QuoteCheckOut",
                pattern: $"{lang}/quotecheckout/",
                defaults: new { controller = "Checkout", action = "QuoteCheckout" });
            ...
            endpointRouteBuilder.MapControllerRoute(name: "CustomerQuotes",
                pattern: $"{lang}/customerquote/history",
                defaults: new { controller = "RequestQuote", action = "CustomerQuotes" });
