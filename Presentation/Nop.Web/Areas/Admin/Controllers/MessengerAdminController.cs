...
{
    public class MessengerAdminController : BasePublicController
    {
        private readonly IQuoteService _quoteService;
        private readonly ICustomerService _customerService;
        private readonly IWorkContext _workContext;

        public MessengerAdminController(IQuoteService quoteService, ICustomerService customerService, IWorkContext workContext)
        {
