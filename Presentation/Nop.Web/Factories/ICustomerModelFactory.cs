...
namespace Nop.Web.Factories
{
    ...
    public partial interface ICustomerModelFactory
    {
        ...
        Task<List<ForwardDetails>> PrepareCustomerListByCustomerQuoteAsync(int customerQuoteId);
        Task<List<ForwardDetails>> PrepareCustomerChatListByCustomerQuoteAsync(int customerQuoteId);
    }
}
