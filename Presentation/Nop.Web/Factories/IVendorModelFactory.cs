...
namespace Nop.Web.Factories
{
    ...
    public partial interface IVendorModelFactory
    {
        ...
        Task<List<ForwardDetails>> PrepareVendorListByCustomerQuoteAsync(int customerQuoteId);

        Task<List<ForwardDetails>> PrepareVendorChatListByCustomerQuoteAsync(int customerQuoteId);
